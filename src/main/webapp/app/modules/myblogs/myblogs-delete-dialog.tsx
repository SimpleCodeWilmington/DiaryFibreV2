...
import { getEntity, deleteEntity } from './myblogs.reducer';

export const MyBlogsDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const handleClose = () => {
    ...
    props.history.push('/myblogs' + props.location.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="diaryFibreApp.blogPost.delete.question">
        <Translate contentKey="diaryFibreApp.blogPost.delete.question" interpolate={{ id: blogPostEntity.id }}>
...
export default MyBlogsDeleteDialog;
