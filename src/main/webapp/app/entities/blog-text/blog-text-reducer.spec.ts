...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './blog-text.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BLOGTEXT_LIST actions', async () => {
    ...
    it('dispatches FETCH_BLOGTEXT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BLOGTEXT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BLOGTEXT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BLOGTEXT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BLOGTEXT actions', async () => {
      const expectedActions = [
        {
