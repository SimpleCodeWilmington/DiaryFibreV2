  ...
  return (
    <div>
      <h2 id="tag-heading" data-cy="TagHeading">
        <Translate contentKey="diaryFibreApp.tag.home.title">Tags</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="diaryFibreApp.tag.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/tag/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="diaryFibreApp.tag.home.createLabel">Create new Tag</Translate>
          </Link>
        </div>
      </h2>
        ...
        {tagList && tagList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="diaryFibreApp.tag.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="diaryFibreApp.tag.tagName">Tag Name</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="diaryFibreApp.tag.home.notFound">No Tags found</Translate>
            </div>
          )
        )}
      </div>
