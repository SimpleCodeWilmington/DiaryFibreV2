...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BLOGCOMMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_BLOGCOMMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BLOGCOMMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BLOGCOMMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BLOGCOMMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BLOGCOMMENT actions', async () => {
      const expectedActions = [
        {
